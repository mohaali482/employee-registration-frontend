import { FormControl, Grid, InputLabel, MenuItem, Select, TextField, Button, Box, Container, CardActions, Snackbar, Alert } from '@mui/material'
      ...
      <CardContent>
        <Box sx={{display: 'flex', flexDirection: { xs: 'column', sm: 'row'}, justifyContent:'center', alignItems: {xs: 'center', sm:'flex-start'}}}>
          <Box width={'40%'} mr={'10px'} sx={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              ...
              <Snackbar open={formErrors.image ? true: false} autoHideDuration={5000}>
                <Alert severity="error" sx={{ width: '100%' }}>
                  Image: {formErrors.image ? formErrors.image.map(error=>error) : ''}
                </Alert>
              </Snackbar>
            ...
            <Grid container spacing={2} sx={{mt: 1}}>
              ...
              <Grid item>
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                    ...
                    error={formErrors.birthDate ? true: false} required
              ...
              <Grid item>
                <FormControl>
                  ...
                  error={formErrors.martialStatus ? true: false} required
              ...
              <Grid item>
                ...
                helperText={formErrors.ssnCode ? formErrors.ssnCode : ''} required
              ...
              <Grid item>
                ...
                helperText={formErrors.postalCode ? formErrors.postalCode : ''}
                variant='outlined' color='secondary' required
              ...
              <Grid item>
                ...
                helperText={formErrors.personalPhone ? formErrors.personalPhone : ''}
